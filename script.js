...
const content = {
  en: {
    ...
    "chapter3.body1":
      "This chapter examines future sea-surface salinity change across CMIP6 scenario simulations and global warming levels. Rather than comparing only end-of-century maps, I build a relationship between SSS change and global mean warming, asking where the surface salinity response scales with warming and where it depends on pathway, basin, or ocean circulation.",
    "chapter3.body2":
      "A central aim is to identify and explain new future salinity patterns. I compare the familiar salty-gets-saltier and fresh-gets-fresher framework with projected pattern shifts, testing whether surface freshwater forcing, advection, mixed-layer processes, and regional circulation reorganize the oceanic water-cycle fingerprint under stronger warming.",
    ...
    "chapter4.body1":
      "This chapter extends the future salinity analysis through the full ocean depth, using emergence diagnostics to identify where forced salinity signals rise above background variability. It treats interior salinity as a water-mass and circulation record, not simply the downward extension of surface freshening or salinification.",
    "chapter4.body2":
      "Using a Bindoff and McDougall (1994)-inspired heave/spice decomposition, I separate changes associated with vertical displacement of density surfaces from water-mass property changes. This links interior salinity emergence to AMOC weakening, ventilation changes, subduction, and basin-scale redistribution, and asks what new patterns of future interior salinity change emerge.",
